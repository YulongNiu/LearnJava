public class Dragon {
    public static void main(String[] args) {
        ...
        System.out.println(dragon0 + " | " + nogard0);
        System.out.println(dragon1 + " | " + nogard1);
        System.out.println(dragon2 + " | " + nogard2);
        System.out.println(dragon3 + " | " + nogard3);
        System.out.println(dragon4 + " | " + nogard4);
        System.out.println(dragon5 + " | " + nogard5);
    }
